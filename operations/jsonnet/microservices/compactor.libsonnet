{
  ...
  tempo_compactor_container::
    ...
    container.withVolumeMounts([
      ...
      if $.tempo_config.use_overrides_configmap then volumeMount.new(tempo_overrides_config_volume, '/overrides')
    ]) +
  ...
  tempo_compactor_deployment:
    ...
    deployment.mixin.spec.template.spec.withVolumes([
      ...
      if $.tempo_config.use_overrides_configmap then volume.fromConfigMap(tempo_overrides_config_volume, $.tempo_config.overrides_configmap_name),
    ]),
